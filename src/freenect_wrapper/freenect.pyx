...
# either License.
#
# Modified 2011 by Jimi van der Woning (jimi@jimbows.net)
#
# Modifications:
# - Added an optional parameter vmode to the runloop function. By passing this
#   variable, you can set the video mode that should be used.
import cython
import numpy as np
...
def runloop(depth=None, video=None, body=None, vmode=VIDEO_RGB):
    ...
    Args:
        ...
        vmode: The video mode that should be used. 
    """
    ...
    freenect_set_video_mode(devp, freenect_find_video_mode(RESOLUTION_MEDIUM, vmode))
