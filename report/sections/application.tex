...
% todo proper equation formatting throughout section instead of \\'s
...
\texttt{FindExtrinsicCameraParams2} function from OpenCV. Because the image is
...
OpenCV. Then, the extrinsic matrix is derived from the translation vector. The
resulting information can be inserted in the equation:\\
\\
...
a costly operation. For all points in the object space, the above equation \\ % use
% reference to label after proper equation formatting determines:
